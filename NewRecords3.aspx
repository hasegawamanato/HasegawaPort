    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style7" style="text-align: right">PCID：</td>
                    <td>
                        <asp:TextBox ID="TextBox2" runat="server" Enabled="False"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7" style="text-align: right">レンタル開始日：</td>
                    <td>
                ...
                <tr>
                    <td class="auto-style7" style="text-align: right">返却予定日：</td>
                    <td>
